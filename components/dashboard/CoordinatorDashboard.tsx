...
interface Props {
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  coordinatorProgramIds: any[];
  isDepartmentWide: boolean;
}

const CoordinatorDashboard: FC<Props> = ({ activeSemesterLabel, facultyCount, instances, pendingCoordinator, coordinatorProgramIds, isDepartmentWide }) => {
